		...
		<div class="modal fade" id="new-device" tabindex="-1" role="dialog" aria-labelledby="New Device" aria-hidden="true">
		  <div class="modal-dialog modal-dialog-centered" role="document">
		    <div class="modal-content">
		      ...
		      <form action="dev_config.php" method="POST" enctype="multipart/form-data">
			      <div class="modal-body">
					<!-- changes device name to device id  -->
			      	<label for="User-mail"><b>Device id:</b></label>  
			      	<input type="text" name="dev_name" id="dev_name" placeholder="Device id..." required/><br>
					<!-- changed device department to schoolbus Name -->
			      	<label for="User-mail"><b>SchoolBus Name:</b></label>
			      	<input type="text" name="dev_dep" id="dev_dep" placeholder="SchoolBus Name..." required/><br>
			      </div>
